      ...
      '/realm/': [
        {
          ...
          items: [
            ...
            { text: '组件架构', link: '/realm/component-architecture' },
            { text: 'Hooks 与 Contexts', link: '/realm/hooks-and-contexts' },
            { text: '自定义服务器', link: '/realm/custom-server' },
      ...
      '/website/': [
        {
          ...
          items: [
            ...
            { text: 'Next.js 配置', link: '/website/next-config' },
      ...
      '/en/realm/': [
        {
          ...
          items: [
            ...
            { text: 'Component architecture', link: '/en/realm/component-architecture' },
            { text: 'Hooks & Contexts', link: '/en/realm/hooks-and-contexts' },
            { text: 'Custom server', link: '/en/realm/custom-server' },
      ...
      '/en/website/': [
        {
          ...
          items: [
            ...
            { text: 'Next.js config', link: '/en/website/next-config' },
